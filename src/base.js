module.exports = class BaseService
{
	...
	getValue(key, verbose = true)
	{
		...
		this.EventManager.setOutputStream('stateUpdate', { sender : this }, { type : 'READ', service : { id : this.id, letters : this.letters, name : this.name }, state });
	...
	setValue(key, value, verbose = true)
	{
		if(key != null && value != null && !isNaN(value))
		{
			if(this.homebridgeAccessory && this.homebridgeAccessory.context)
			{
				...
				this.EventManager.setOutputStream('stateUpdate', { sender : this }, { type : 'WRITE', service : { id : this.id, letters : this.letters, name : this.name }, state });
